...
import torchopenl3
import torchopenl3.utils as utils
from torchopenl3.timefreq import Melspectrogram
...
def _load_spectrogram_model(input_repr):
    if input_repr == 'mel128':
        return Melspectrogram(sr=torchopenl3.SAMPLE_RATE, n_mels=128,
                              fmin=0.0, fmax=None, power_melgram=1.0, 
                              return_decibel_melgram=True, trainable_fb=False, 
                              htk=True)
    elif input_repr == 'mel256':
        return Melspectrogram(sr=torchopenl3.SAMPLE_RATE, n_mels=256,
                              fmin=0.0, fmax=None, power_melgram=1.0, 
                              return_decibel_melgram=True, trainable_fb=False, 
                              htk=True)
